module.exports = {
    ...
    REMOVE_ADDRESS: 'You can remove your wallet address before verification by using the /remove command.',
    USERNAME_NOT_FOUND: 'Username not found. Please set it and try again.',
}
